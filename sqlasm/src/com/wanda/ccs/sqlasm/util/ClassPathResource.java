package com.wanda.ccs.sqlasm.util;
...
public class ClassPathResource  {
	...
	public File getFile() throws IOException {
		if(this.file == null) {
			try {
				this.file = new File(getURL().toURI());
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof ClassPathResource) {
			...
			return (this.path.equals(otherRes.path) &&
					ValueUtils.nullSafeEquals(this.classLoader, otherRes.classLoader) &&
					ValueUtils.nullSafeEquals(this.clazz, otherRes.clazz));
		}
		return false;
	}
